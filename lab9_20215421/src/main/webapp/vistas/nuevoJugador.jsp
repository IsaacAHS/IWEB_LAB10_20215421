...
<body>
<div class='container'>
    <h1 class='mb-3'>Crear un nuevo jugador</h1>
    <!--
    ...
    -->
    <form method="post" action="<%=request.getContextPath()%>/ServletJugador">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="seleccion">
        </div>

        <a href="<%=request.getContextPath()%>/ServletJugador" class="btn btn-danger">Regresar</a>
